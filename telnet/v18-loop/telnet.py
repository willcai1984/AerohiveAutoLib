...
from console import generate_cli_sendmode_expect_timeout_wait_list, debug, sleep, spawn_timeout_retry, generate_cli_list, execute_command_via_cli_sendmode_expect_timeout_wait_list, general_login, str2list
...
#v19 start
parse.add_argument('-i', '--interface', required=False, default='23', dest='port_list',
                    help="Serial port list, such as '2-10'")
#v19 end
...
parse.add_argument('-loop', '--loop', required=False, default='1', dest='loop',
                    help="The loop value range, such as '3-10'")
#v19 end
