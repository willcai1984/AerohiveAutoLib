...
#                    debug('Login successfully, can execute cli now',is_debug)
                    ...
                    ###retry retrytimes times to type 'enter' to confirm login
            ...
            if nor_index == 2 or nor_retry_index == 3 or retry_index == 3:
                debug('Login successfully, can execute cli now',is_debug)
...
parse.add_argument('-k', '--retry', required=False, default=18, type= int, dest='retrytimes',
