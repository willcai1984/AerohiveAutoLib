...
class ssh_host:
    ...
    def __del__(self):
        if self.absolute_logfile == './stdout':
            ...
            print "Enter to logfile shaping process"
...
# v18 start
parse.add_argument('-c', '--circle', required=False, action='append', default=[], dest='loop_list',
                    help='The loop list you want to execute CLIs, such as "f:9" and "i:2-10"')
# v18 end
