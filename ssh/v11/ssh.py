...
###v10 add wait_time
def ssh_execute_cli(ip, user, passwd, cli_list, port, timeout, prompt, logdir, logfile, is_debug, is_shell, shellpasswd, wait_time):
...
def main():
    ...
    try:
        ...
        ssh_result = ssh_execute_cli(ip, user, passwd, execute_cli_list, port, timeout, prompt, logdir, logfile, is_debug, is_shell, shellpasswd, wait_time)
    except Exception, e:
        print str(e)
    else:
        return ssh_result
